...
namespace STARS.Applications.VETS.Plugins.SOC.Interface
{
    ...
    [AsyncTestActivity(typeof(IEmissionTestRunContext),
        TriggerState = EmissionTestStates.TestStart,
        BlockStateExit = EmissionTestStates.TestStart)]
    internal class OnCycleStart : IAsyncTestActivity<IEmissionTestRunContext>
    {
